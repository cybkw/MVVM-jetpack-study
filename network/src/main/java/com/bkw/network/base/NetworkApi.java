...
import com.bkw.network.converter.FastJsonConverterFactory;
import com.bkw.network.converter.LiveDataCallAdapter;
import com.bkw.network.converter.LiveDataCallAdapterFactory;
import com.bkw.network.environment.EnvironmentActivity;
import com.bkw.network.environment.IEnvironment;
import com.bkw.network.errorhandler.HttpErrorHandler;
import com.bkw.network.interceptor.CommonRequestInterceptor;
import com.bkw.network.interceptor.CommonResponseInterceptor;
...
import static com.bkw.network.environment.EnvironmentActivity.*;
...
public abstract class NetworkApi implements IEnvironment {
    ...
    public static void init(INetworkRequiredInfo networkRequiredInfo) {
        ...
        mIsFormal = isOfficialEnvironment(networkRequiredInfo.getApplicationContext());
    }
