...
//        Logger.d("11=" + targetDensity + ",targetScaleDensity=" + targetScaleDensity + ",targetDensityDpi=" + targetDensityDpi);
        appDisplayMetrics.density = targetDensity;
        appDisplayMetrics.scaledDensity = targetScaleDensity;
        appDisplayMetrics.densityDpi = targetDensityDpi;

//        Logger.d("" + targetDensity + ",targetScaleDensity=" + targetScaleDensity + ",targetDensityDpi=" + targetDensityDpi);
    ...
    public static int px2dp(float pxValue) {
        final float scale = DisplayUtils.context.getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float scale = DisplayUtils.context.getResources().getDisplayMetrics().scaledDensity;
        return (int) (pxValue / scale + 0.5f);
    }
